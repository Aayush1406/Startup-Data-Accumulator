...
public class WhatsSchemeEligibilityIntentHandler implements RequestHandler{

	public static final String SCHEME_SLOT="Scheme";
	public static final String SCHEME_KEY="SCHEME";
	
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("WhatsSchemeEligibilityIntent"));
    }

    public Optional<Response> handle(HandlerInput input) {
    	System.out.println("*****************WhatsSchemeEligibilityIntent start************");
        ...
        if(schemeSlot != null) {
    		...
    		List ls=d.getSchemeEligibility(schemeName);
    		String speech="";
    		if(ls.size()>0){
    			...
    			speechText = "The eligibility criteria for this scheme are, "+speech;
    		}else{
        ...
        return input.getResponseBuilder()
                .withSimpleCard("Scheme Eligibility Criteria", speechText)
