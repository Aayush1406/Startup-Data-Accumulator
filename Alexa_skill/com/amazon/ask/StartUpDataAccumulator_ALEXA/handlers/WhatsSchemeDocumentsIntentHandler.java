...
public class WhatsSchemeDocumentsIntentHandler  implements RequestHandler{

	public static final String SCHEME_SLOT="Scheme";
	public static final String SCHEME_KEY="SCHEME";
	
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("WhatsSchemeDocumentIntent"));
    }

    public Optional<Response> handle(HandlerInput input) {
    	System.out.println("*****************WhatsSchemeDocumentIntent start************");
        ...
        if(schemeSlot != null) {
            ...
            System.out.println("***************** WhatsSchemeIntent end********************");
           
            
            Database d = new Database();
    		List ls=d.getSchemeDocument(schemeName);
    		String speech="";
    		if(ls.size()>0){
    			...
    			speechText = "The documents required for this scheme are "+speech;
    		}else{
        ...
        System.out.println("***************** WhatsSchemeDocumentIntent ends********************");
        return input.getResponseBuilder()
                .withSimpleCard("Scheme Documents", speechText)
