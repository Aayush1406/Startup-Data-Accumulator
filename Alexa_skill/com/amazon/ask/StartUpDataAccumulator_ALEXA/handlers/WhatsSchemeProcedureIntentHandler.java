...
public class WhatsSchemeProcedureIntentHandler implements RequestHandler{

	public static final String SCHEME_SLOT="Scheme";
	public static final String SCHEME_KEY="SCHEME";
	
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("WhatsSchemeProcedureIntent"));
    }

    public Optional<Response> handle(HandlerInput input) {
    	System.out.println("*****************WhatsSchemeProcedureIntent start************");
        ...
        if(schemeSlot != null) {
    		...
    		List ls=d.getSchemeHowToApply(schemeName);
    		String speech="";
    		if(ls.size()>0){
        ...
        return input.getResponseBuilder()
                .withSimpleCard("Scheme How to apply", speechText)
