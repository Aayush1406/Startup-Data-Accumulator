...
public class WhatsSchemeIntentHandler implements RequestHandler{

	public static final String SCHEME_SLOT="Scheme";
	public static final String SCHEME_KEY="SCHEME";
	
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("WhatsSchemeIntent"));
    }

    public Optional<Response> handle(HandlerInput input) {
    	System.out.println("*****************WhatsSchemeIntent start************");
        ...
        if(schemeSlot != null) {
    		...
    		List ls=d.getSchemeDescription(schemeName);
    		String speech="";
    		if(ls.size()>0){
        ...
        return input.getResponseBuilder()
                .withSimpleCard("Scheme Description", speechText)
