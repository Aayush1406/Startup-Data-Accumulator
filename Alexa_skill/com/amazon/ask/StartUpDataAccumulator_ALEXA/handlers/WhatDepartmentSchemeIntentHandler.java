...
public class WhatDepartmentSchemeIntentHandler implements RequestHandler {
	...
	public boolean canHandle(HandlerInput input) {
		...
		return  input.matches(intentName("WhatsDepartmentSchemeIntent"));
	}

	@Override
	public Optional<Response> handle(HandlerInput input) {
		
	System.out.println("***************** WhatsDepartmentSchemeIntent start************");
        ...
        if(departmentSlot != null) {
    		...
    		List ls=d.getAllDepartmentSchemes(departmentName);
    		String speech="";
    		if(ls.size()>0){
        ...
        System.out.println("***************** WhatsDepartmentSchemeIntent ends********************");
        return input.getResponseBuilder()
                .withSimpleCard("Department Scheme", speechText)
