		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View Scheme</h4>
							<div class="row">
								<div class="col-12">
										...
										<table id="order-listing" class="table">
											<thead>
												<tr>
													...
													<th>Scheme Eligibility</th>
													<th>Scheme How To apply</th>
			  									    <th>Scheme Benefits</th> 
													<th>Scheme List Of Docs Required</th>													
													<th>Action</th>
													
												</tr>
											</thead>
											<tbody>
										<c:forEach var="i" items="${schemeList}" varStatus="j">
												<tr>
																				
													<td>${j.count}</td>
													<td>${i.ministryVO.ministryName}</td>
													<td>${i.departmentVO.departmentName}</td>
													<td>${i.schemeLink}</td>
													<td>${i.schemeName}</td>
													<td>${i.schemeDescription}</td>
			 										<td>${i.schemeECriteria}</td> 
													<td>${i.schemeHowToApply}</td>
													<td>${i.schemeBenefits}</td>
													<td>${i.schemeListOfDocs}</td>
													<td>
													
														<a href="editScheme?schemeId=${i.schemeId}">
															<i class="mdi mdi-pencil lead"></i>
														</a>
														
														<a href="deleteScheme?schemeId=${i.schemeId}">
