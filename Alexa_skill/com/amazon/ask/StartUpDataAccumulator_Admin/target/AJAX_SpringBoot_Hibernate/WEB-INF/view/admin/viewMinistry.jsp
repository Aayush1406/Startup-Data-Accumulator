		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View Ministry</h4>
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
											<c:forEach var="i" items="${ministryList}" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.ministryName}</td>
													<td>${i.ministryDescription}</td>
													<td>
														<a href="editMinistry?ministryId=${i.ministryId}">
															<i class="mdi mdi-pencil lead"></i>
														</a>
														
														<a href="deleteMinistry?ministryId=${i.ministryId}">
