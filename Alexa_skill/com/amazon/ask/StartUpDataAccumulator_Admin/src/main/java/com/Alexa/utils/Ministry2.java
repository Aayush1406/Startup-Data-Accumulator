...
public class Ministry2 {
	...
	public Ministry2(String url,SchemeVO schemeVO) {
		this.url = url;
...
public static String getHowToApply() throws IOException{
		...
		public static SchemeVO getDetails() throws Exception{
			String schemeName = Ministry2.getSchemeName();	
			String schemeBenefits=Ministry2.getSchemeBenefits();
			String schemeECriteria = Ministry2.getSchemeECriteria();
			String schemeHowToApply=Ministry2.getHowToApply();	
			String schemeDescription=Ministry2.getSchemeDescription();
			String schemeListOfDocs=Ministry2.getListOfDocs();
