...
public class Ministry7 {

	private static String url;
	private static SchemeVO schemeVO;
	
	public Ministry7(String url,SchemeVO schemeVO) {
		this.url = url;
...
public  static String getHowToApply() throws IOException{
	...
	public static SchemeVO getDetails() throws Exception{
		String schemeName = Ministry7.getSchemeName();	
		String schemeBenefits=Ministry7.getSchemeBenefits();
		String schemeECriteria = Ministry7.getSchemeECriteria();
		String schemeHowToApply=Ministry7.getHowToApply();	
		String schemeDescription=Ministry7.getSchemeDescription();
		String schemeListOfDocs=Ministry7.getListOfDocs();
