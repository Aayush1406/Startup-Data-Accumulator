...
public class Ministry10 {

	private static String url;
	private static SchemeVO schemeVO;
	
	public Ministry10(String url,SchemeVO schemeVO) {
		this.url = url;
	...
	public  static String getHowToApply() throws IOException{
		...
		public static SchemeVO getDetails() throws Exception{
			String schemeName = Ministry10.getSchemeName();	
			String schemeBenefits=Ministry10.getSchemeBenefits();
			String schemeECriteria = Ministry10.getSchemeECriteria();
			String schemeHowToApply=Ministry10.getHowToApply();	
			String schemeDescription=Ministry10.getSchemeDescription();
			String schemeListOfDocs=Ministry10.getListOfDocs();
