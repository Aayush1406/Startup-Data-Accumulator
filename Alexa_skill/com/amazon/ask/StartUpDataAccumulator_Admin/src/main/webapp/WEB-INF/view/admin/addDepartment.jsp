						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<f:form  method="post" action="insertDepartment" modelAttribute="DepartmentVO">
									<f:hidden path="departmentId"/>
										...
										<label>Ministry Name</label>
											...
											<div class="form-group">
												<label for="cname">Department Name</label> <f:input id="cname"
													class="form-control" path="departmentName" minlength="2" type="text"
													required="required"/>
											</div>

											<div class="form-group">
												<label for="ccomment">Department Description</label>
												<f:textarea id="ccomment" class="form-control" path="departmentDescription"
													></f:textarea>
											</div>
