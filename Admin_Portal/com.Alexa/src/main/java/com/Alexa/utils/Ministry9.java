...
public static void main(String[] args) throws Exception{
			...
			Ministry9.getSchemeName();
			Ministry9.getSchemeDescription();
			Ministry9.getSchemeBenefits();
			Ministry9.getSchemeECriteria();
			Ministry9.getHowToApply();
			Ministry9.getListOfDocs();
			}
