...
public static void main(String[] args) throws Exception{
			...
			Ministry10.getSchemeName();
			Ministry10.getSchemeDescription();
			Ministry10.getSchemeBenefits();
			Ministry10.getSchemeECriteria();
			Ministry10.getHowToApply();
			Ministry10.getListOfDocs();
			}
