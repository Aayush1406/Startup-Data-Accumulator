...
public  static void getHowToApply() throws IOException{
	...
	public static void main(String[] args) throws Exception{
		...
		Ministry4.getSchemeName();
		Ministry4.getSchemeDescription();
		Ministry4.getSchemeBenefits();
		Ministry4.getSchemeECriteria();
		Ministry4.getHowToApply();
		Ministry4.getListOfDocs();
		}
