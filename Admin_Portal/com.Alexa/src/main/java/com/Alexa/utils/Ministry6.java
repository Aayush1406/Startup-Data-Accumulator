...
public  static void getHowToApply() throws IOException{
	...
	public static void main(String[] args) throws Exception{
		...
		Ministry6.getSchemeName();
		Ministry6.getSchemeDescription();
		Ministry6.getSchemeBenefits();
		Ministry6.getSchemeECriteria();
		Ministry6.getHowToApply();
		Ministry6.getListOfDocs();
		}
