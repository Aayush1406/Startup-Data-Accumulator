...
public static void getHowToApply() throws IOException{
		...
		public static void main(String[] args) throws Exception{
			...
			Ministry2.getSchemeName();
			Ministry2.getSchemeDescription();
			Ministry2.getSchemeBenefits();
			Ministry2.getSchemeECriteria();
			Ministry2.getHowToApply();
			Ministry2.getListOfDocs();
			}
