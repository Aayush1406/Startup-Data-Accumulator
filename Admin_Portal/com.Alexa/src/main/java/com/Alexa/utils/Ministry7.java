...
public  static void getHowToApply() throws IOException{
	...
	public static void main(String[] args) throws Exception{
		...
		Ministry7.getSchemeName();
		Ministry7.getSchemeDescription();
		Ministry7.getSchemeBenefits();
		Ministry7.getSchemeECriteria();
		Ministry7.getHowToApply();
		Ministry7.getListOfDocs();
		}
